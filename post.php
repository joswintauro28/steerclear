...
<html lang="en" dir="ltr">
	<head>
		...
		<title>STEER CLEAR | more</title>
	</head>
	<body>
		<div class="nav">
			<a href="javascript:history.back();"><i class="fas fa-angle-double-left"></i></a><h1>STEER CLEAR</h1>
		</div>
			...
			<div class="results">
				<?php
					...
					echo '<div class="image"  style="background-image:url(assets/Thought_images/'.$row['image'].');
						...
						<div class="text">
							<h2>'.$row['title'].'</h2>
							<i class="far fa-user"> <p style="display: inline;">steer clear</p></i>
