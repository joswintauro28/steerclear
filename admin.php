...
<html lang="en" dir="ltr">
	<head>
		...
		<title>steer clear | admin</title>
	</head>
	<body>
		<header>
			<div class="heading">
				<h1><a href="index.php"><i class="fas fa-angle-double-left"></i></a>S T E E R - C L E A R <span> Admin </span> </h1>
			</div>
			<nav>
				<h3>ORDERS</h3>
				<h3>USERS</h3>
		...
		<footer>
		  ...
		  <div class="credit">
		  	<h1>STEER CLEARS | Developed by STEER CLEAR TEAM</h1>
		  </div>
		</footer>
